...
<main class="main about">
    ...
    style="background: #D4E1EA url('{{ config('custom.public_path') }}/frontAssets/assets/images/page-header-bg.jpg') center/cover no-repeat;">   <div class="container">
            ...
            <div class="testimonials-carousel owl-carousel owl-theme images-left" data-owl-options="{
                ...
                <div class="testimonial">
                    <div class="testimonial-owner">
                        <figure>
                            <img src=" {{ config('custom.public_path') . '/frontAssets/assets/images/clients/client1.png' }}" alt="client">
                        </figure>
                ...
                <div class="testimonial">
                    <div class="testimonial-owner">
                        <figure>
                            <img src="{{ config('custom.public_path') . '/frontAssets/assets/images/clients/client2.png' }}" alt="client">
                        </figure>
