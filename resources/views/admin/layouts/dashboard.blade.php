                                ...
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">Wallet Balance
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">Today's PayIn
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-start justify-content-between mb-4">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <h3 class="fs-13 fw-semibold text-truncate-1-line">Today's PayOut
                                            </h3>
                                        </div>
                                    </div>
                                </div>
