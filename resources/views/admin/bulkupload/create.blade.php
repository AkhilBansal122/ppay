                ...
                <div class="page-header-right ms-auto">
                    <div class="page-header-right-items">
                        <div class="d-flex d-md-none">
                            <a href="{{ route('bulkUpload') }}" class="page-header-right-close-toggle">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 mb-4">
                                            <label class="form-label">Transfer Amount <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" required step="0.01" name="transfer_amount"
                                                value="{{ old('transfer_amount') }}" placeholder="Enter transfer amount"
                                                class="form-control" />
                                        ...
                                        <div class="col-lg-4 mb-4">
                                            ...
                                            <select name="payment_mode" class="form-select form-select-solid" required>
                                                ...
                                                <option value="NEFT"
                                                    {{ old('payment_mode') == 'NEFT' ? 'selected' : '' }}>NEFT</option>
                                                <option value="IMPS"
                                                    {{ old('payment_mode') == 'IMPS' ? 'selected' : '' }}>IMPS</option>
                                                <option value="RTGS"
                                                    {{ old('payment_mode') == 'RTGS' ? 'selected' : '' }}>RTGS</option>
                                            </select>
